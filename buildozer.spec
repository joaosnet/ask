...
requirements = kivy==master, https://github.com/kivymd/KivyMD/archive/master.zip, requests==2.31.0, mapview==1.0.6, https://github.com/HyTurtle/plyer/archive/master.zip, watchdog 
